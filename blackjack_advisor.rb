...
def return_strategy_for_hard_hand(user_total, house_card, strategy)
  solution = strategy[user_total][house_card]
end
...
if player_first_card == player_second_card
  pair(player_first_card, dealers_card, what_to_do_with_a_pair) #will add
